...
# to `npm ci --ignore-scripts && bddgen && playwright test --update-snapshots --remove-obsolete-snapshots`
# where --remove-obsolete-snapshots is a theoretical flag used by Playwright to remove
